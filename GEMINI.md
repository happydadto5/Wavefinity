...
- **Testing:** Strict default of **NO TESTING** as defined in [README.md](README.md). Routine work (Class A & B) requires zero tests, no dev server, no browser checks. Minimal targeted testing is only permitted for rare Class C high-blast-radius architectural changes.
